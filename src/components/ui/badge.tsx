...
const badgeVariants = cva(
  "inline-flex items-center rounded px-1.5 py-0.5 text-[11px] font-medium transition-colors",
  {
    variants: {
      variant: {
        default: "bg-emerald-600/20 text-emerald-300 border border-emerald-600/30",
        ...
        info: "bg-emerald-600/15 text-emerald-400 border border-emerald-600/20",
        purple: "bg-emerald-600/15 text-emerald-400 border border-emerald-600/20",
      },
    },
