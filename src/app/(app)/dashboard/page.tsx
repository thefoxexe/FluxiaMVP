...
export default function DashboardPage() {
  ...
  const STATS = [
    ...
    { title: "CA annuel", value: formatCurrency(yearRevenue), icon: Target, color: "text-violet-400", bg: "bg-violet-500/10", sub: "cumulé depuis janvier" },
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={220}>
                <AreaChart data={chartData} margin={{ top: 5, right: 5, bottom: 0, left: 0 }}>
                  ...
                  <Area type="monotone" dataKey="revenue" name="Revenus" stroke="#7c3aed" strokeWidth={2} fill="url(#revGrad)" dot={false} />
